...
target_dir = 'P:/BaTh/Dataset4_22-04-22/tIntervSeg_results_segmented'

# name relevant subdirectories of source directors
edg1h = os.path.join(source_dir, 'tests_edg1h_24-11-22_sorted')
edg2h = os.path.join(source_dir, 'tests_edg2h_24-11-22_sorted')
edg3h = os.path.join(source_dir, 'tests_edg3h_30-11-22_sorted')
edg4h = os.path.join(source_dir, 'tests_edg4h_19-12-22_sorted')

# merge all relevant directories as a list of tuples
dirs_raw = [edg1h, edg2h, edg3h, edg4h]
dirs = []
