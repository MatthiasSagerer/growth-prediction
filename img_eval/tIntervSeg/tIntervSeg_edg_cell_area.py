...
edg_workb_path = 'C:/Users/Matthias Sagerer/Documents/TUM/bachelor_thesis/growth-prediction/results_xlsx/tIntervSeg_edg/tIntervSeg_edg_cell_area.xlsx'
...
for dir_nr, dirs in enumerate(edg_dirs):
    ...
    for j, (vid_gt, vid_pred) in enumerate(zip(vids_gt, vids_pred)):
        ...
        for frame, (fr_gt, fr_pred) in enumerate(zip(frs_gt[6:], frs_pred[6:]), 7):
            ...
            metric = calCellArea(cur_gt_fr, cur_pred_fr)
